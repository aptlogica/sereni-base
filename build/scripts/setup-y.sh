...
if [[ "$OSTYPE" == "darwin"* ]]; then
    ...
    grep -q "^CORS_ALLOWED_ORIGINS=" .env || echo "CORS_ALLOWED_ORIGINS=http://localhost:5050,http://127.0.0.1:5050,http://$PUBLIC_HOST:5050,http://base-ui:5050,http://serenibase:8080" >> .env
