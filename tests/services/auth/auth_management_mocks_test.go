...
type authProviderMock struct {
	...
	RefreshTokenFn  func(ctx context.Context, reqBody authProviderInterface.AuthServiceRefreshRequest) (authProviderInterface.Tokens, error)
	ValidateTokenFn func(ctx context.Context, tokenStr string) (authProviderInterface.Claims, error)
	LoginFn         func(ctx context.Context, reqBody authProviderInterface.AuthServiceLoginRequest) (authProviderInterface.Tokens, error)
...
func (m *authProviderMock) RefreshToken(ctx context.Context, reqBody authProviderInterface.AuthServiceRefreshRequest) (authProviderInterface.Tokens, error) {
	if m.RefreshTokenFn != nil {
		return m.RefreshTokenFn(ctx, reqBody)
	}
	return authProviderInterface.Tokens{}, nil
}
...
func (m *authProviderMock) Login(ctx context.Context, reqBody authProviderInterface.AuthServiceLoginRequest) (authProviderInterface.Tokens, error) {
	if m.LoginFn != nil {
		return m.LoginFn(ctx, reqBody)
	}
	return authProviderInterface.Tokens{}, nil
}
