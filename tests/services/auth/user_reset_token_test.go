...
func (m *MockTableServiceResetToken) UpdateByColumns(tableName string, where dbModels.ComplexFilter, data map[string]any) (map[string]interface{}, error) {
...
func (m *MockTableServiceResetToken) DeleteByColumns(tableName string, where dbModels.ComplexFilter) (int64, error) {
