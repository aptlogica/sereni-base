...
func (m *MockTableServiceUM) UpdateByColumns(tableName string, where dbModels.ComplexFilter, data map[string]any) (map[string]interface{}, error) {
...
func (m *MockTableServiceUM) DeleteByColumns(tableName string, where dbModels.ComplexFilter) (int64, error) {
...
func (m *MockAuthProviderUM) RefreshToken(ctx context.Context, reqBody authProviderInterface.AuthServiceRefreshRequest) (authProviderInterface.Tokens, error) {
	return authProviderInterface.Tokens{}, nil
}
...
func (m *MockAuthProviderUM) Login(ctx context.Context, reqBody authProviderInterface.AuthServiceLoginRequest) (authProviderInterface.Tokens, error) {
	return authProviderInterface.Tokens{}, nil
}
