...
var AuthErrorCodes = map[ResponseCode]MetaResponse{
	AuthError.FirstNameRequired:        {HTTPStatus: http.StatusBadRequest, Message: "Invalid request payload", Description: "First name is required"},
	AuthError.LastNameRequired:         {HTTPStatus: http.StatusBadRequest, Message: "Invalid request payload", Description: "Last name is required"},
	AuthError.FirstNameInvalid:         {HTTPStatus: http.StatusBadRequest, Message: "Invalid request payload", Description: "First name is invalid"},
	AuthError.LastNameInvalid:          {HTTPStatus: http.StatusBadRequest, Message: "Invalid request payload", Description: "Last name is invalid"},
	AuthError.EmailRequired:            {HTTPStatus: http.StatusBadRequest, Message: "Invalid request payload", Description: "Email is required"},
	AuthError.EmailInvalidFormat:       {HTTPStatus: http.StatusBadRequest, Message: "Invalid request payload", Description: "Email format is invalid"},
	AuthError.EmailInvalid:             {HTTPStatus: http.StatusBadRequest, Message: "Invalid request payload", Description: "Email is invalid"},
	AuthError.PasswordRequired:         {HTTPStatus: http.StatusBadRequest, Message: "Invalid request payload", Description: "Password is required"},
	AuthError.PasswordTooShort:         {HTTPStatus: http.StatusBadRequest, Message: "Invalid request payload", Description: "Password is too short"},
	AuthError.PasswordInvalid:          {HTTPStatus: http.StatusBadRequest, Message: "Invalid request payload", Description: "Password is invalid"},
	AuthError.OrganizationNameRequired: {HTTPStatus: http.StatusBadRequest, Message: "Invalid request payload", Description: "Organization name is required"},
	AuthError.OrganizationNameInvalid:  {HTTPStatus: http.StatusBadRequest, Message: "Invalid request payload", Description: "Organization name is invalid"},
	AuthError.InvalidOTP:               {HTTPStatus: http.StatusBadRequest, Message: "Invalid OTP", Description: "Invalid OTP"},
	AuthError.UserIDRequired:           {HTTPStatus: http.StatusBadRequest, Message: "Invalid request payload", Description: "User ID is required"},
	AuthError.UserIDInvalidFormat:      {HTTPStatus: http.StatusBadRequest, Message: "Invalid request payload", Description: "User ID format is invalid"},
	AuthError.UserIDInvalid:            {HTTPStatus: http.StatusBadRequest, Message: "Invalid request payload", Description: "User ID is invalid"},
	AuthError.OTPRequired:              {HTTPStatus: http.StatusBadRequest, Message: "Invalid request payload", Description: "OTP is required"},
	AuthError.OTPInvalid:               {HTTPStatus: http.StatusBadRequest, Message: "Invalid request payload", Description: "OTP is invalid"},
	AuthError.SubscriptionIDRequired:   {HTTPStatus: http.StatusBadRequest, Message: "Invalid request payload", Description: "Subscription ID is required"},
	AuthError.SubscriptionIDInvalid:    {HTTPStatus: http.StatusBadRequest, Message: "Invalid request payload", Description: "Subscription ID is invalid"},
	AuthError.RoleIDRequired:           {HTTPStatus: http.StatusBadRequest, Message: "Invalid request payload", Description: "Role ID is required"},
	AuthError.RoleIDInvalid:            {HTTPStatus: http.StatusBadRequest, Message: "Invalid request payload", Description: "Role ID is invalid"},
	AuthError.SchemaRequired:           {HTTPStatus: http.StatusBadRequest, Message: "Invalid request payload", Description: "Header 'schema' is required"},
	AuthError.InvalidSchema:            {HTTPStatus: http.StatusBadRequest, Message: "Invalid schema", Description: "Provided schema is invalid"},
	AuthError.RefreshTokenRequired:     {HTTPStatus: http.StatusBadRequest, Message: "Invalid request payload", Description: "Refresh token is required"},
	AuthError.RefreshTokenInvalid:      {HTTPStatus: http.StatusBadRequest, Message: "Invalid request payload", Description: "Refresh token is invalid"},
	...
	AuthError.DateOfBirthRequired:      {HTTPStatus: http.StatusBadRequest, Message: "Invalid request payload", Description: "Date of birth is required"},
	AuthError.DateOfBirthInvalid:       {HTTPStatus: http.StatusBadRequest, Message: "Invalid request payload", Description: "Date of birth is invalid"},
	AuthError.CountryRequired:          {HTTPStatus: http.StatusBadRequest, Message: "Invalid request payload", Description: "Country is required"},
	AuthError.CountryInvalid:           {HTTPStatus: http.StatusBadRequest, Message: "Invalid request payload", Description: "Country is invalid"},
	AuthError.TimezoneRequired:         {HTTPStatus: http.StatusBadRequest, Message: "Invalid request payload", Description: "Timezone is required"},
	AuthError.TimezoneInvalid:          {HTTPStatus: http.StatusBadRequest, Message: "Invalid request payload", Description: "Timezone is invalid"},
	AuthError.WorkspaceRequired:        {HTTPStatus: http.StatusBadRequest, Message: "Invalid request payload", Description: "Header 'workspace' is required"},
	AuthError.BaseRequired:             {HTTPStatus: http.StatusBadRequest, Message: "Invalid request payload", Description: "Header 'base' is required"},
	...
	AuthError.InternalServerError:      {HTTPStatus: http.StatusInternalServerError, Message: "Internal server error", Description: "An error occurred on the server"},
