...
type ImportService interface {
	...
	FetchAiBaseSchema(ctx context.Context, prompt string) (dto.AiBaseResponse, error)
	ApplyAiBaseSchema(ctx context.Context, schemaName string, req dto.CreateTableRequest, aiResponse dto.AiBaseResponse, sample bool, rows int) (dto.ImportBaseResponse, error)
}
